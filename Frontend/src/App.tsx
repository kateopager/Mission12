...
function Welcome(){
  return(<h1> Some awesome teams! </h1>);
}

class TeamInfo extends React.Component
<{name: string; school: string; city: string; state: string}>  {
  render() { 
  ...
  <tr>
     <td><h2>University: </h2></td>
      <td><h2>{team.school} </h2></td>
  </tr>
    <tr>
    <td><h3>Mascot Name: </h3></td>
    <td><h3>{team.name} </h3></td>
      </tr>
      <tr>
      <td><h3>Location: </h3></td>
      <td><h3>{team.city} </h3></td>
    </tr>
    </table> 
    );
  }
...
function TeamList(){
  return(
  <div>
    {CollegeBasketballTeams.map(team => <TeamInfo {...team}/>)}
  </div>
  );
}
  ...
  return (
    <div className="App">
      <header className="App-header">
        <p>
        College Basketball Teams and Their Information
        </p>
      <Welcome/>
      <TeamList/>
        <a
